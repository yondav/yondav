...
type DefaultAttributeFills = {
  [Key in keyof AssembledPortrait]: {
    [SubKey: string]: {
      [SubSubKey in 'primary' | 'secondary' | 'tertiary']: Color | null;
    };
  };
};

export const defaultAttributeFills: DefaultAttributeFills = {
...
export const eyebrowTypes = [
  'none',
  ...Object.keys(defaultEyebrowFills),
] as EyebrowType[];
export const eyeTypes = ['none', ...Object.keys(defaultEyeFills)] as EyeType[];
export const glassesTypes = [
  'none',
  ...Object.keys(defaultGlassesFills),
] as GlassesType[];
export const facialHairTypes = [
  'none',
  ...Object.keys(defaultFacialHairFills),
] as FacialHairType[];
export const hairTypes = ['none', ...Object.keys(defaultHairFills)] as HairType[];
export const hatTypes = ['none', ...Object.keys(defaultHatFills)] as HatType[];
export const mouthTypes = ['none', ...Object.keys(defaultMouthFills)] as MouthType[];
export const shirtTypes = ['none', ...Object.keys(defaultShirtFills)] as ShirtType[];
export const skinTypes = Object.keys(defaultSkinFills) as SkinType[];
