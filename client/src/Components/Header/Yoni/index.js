...
const Yoni = ({ clear, customColors, onCustomColor }) => {
      ...
      >
        ...
        <g id='sleeve-accent'>
          <motion.path
            ...
            stroke={clear === 'customize' ? '#000000' : fills.shirt.primary}
        ...
        <g id='collar-thread'>
          <motion.path
            stroke={clear === 'customize' ? '#000000' : fills.shirt.band_accent}
        ...
        <g id='glasses'>
          ...
          />
          <motion.path
            stroke={clear === 'customize' ? '#000000' : fills.glasses[6]}
            strokeWidth={clear === 'customize' ? '1px' : '2px'}
            fill='none'
