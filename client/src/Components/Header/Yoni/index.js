        ...
        >
          ...
          <g id='hair'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(1) : () => ''}
              stroke={fills.black}
          ...
          <g id='skin'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(2) : () => ''}
              stroke={fills.black}
          ...
          <g id='skin-shadows'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(3) : () => ''}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(4) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(5) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
          ...
          <g id='eye-backs'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(7) : () => ''}
              stroke={fills.black}
          ...
          <g id='Pupils'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(8) : () => ''}
              stroke={fills.black}
          ...
          <g id='beard'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(9) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
          ...
          <g id='eyebrows'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(10) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
          ...
          <g id='sleeve-body'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(11) : () => ''}
              stroke={fills.black}
          ...
          <g id='sleeve-accent'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(12) : () => ''}
          ...
          <g id='shirt-body'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(13) : () => ''}
              stroke={fills.black}
          ...
          <g id='hat_bill' data-name='hat bill'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(14) : () => ''}
              stroke={fills.black}
          ...
          <g id='hat_top' data-name='hat top'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(15) : () => ''}
              stroke={fills.black}
          ...
          <g id='glasses'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(16) : () => ''}
              stroke={fills.black}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(17) : () => ''}
              stroke={fills.black}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(18) : () => ''}
              stroke={fills.black}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(19) : () => ''}
              stroke={fills.black}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(20) : () => ''}
              stroke={fills.black}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(21) : () => ''}
              stroke={fills.black}
          ...
          <g id='mouth'>
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(22) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(23) : () => ''}
              stroke={clear === 'customize' ? fills.black : ''}
            ...
            <Path
              clear={clear}
              erase={erase}
              tap={clear === 'customize' ? () => onCustomColor(24) : () => ''}
              stroke={fills.black}
