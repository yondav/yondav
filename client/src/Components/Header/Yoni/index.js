      ...
      >
        <g id='shadow'>
          <motion.polygon
            ...
            onClick={clear === 'customize' ? () => onCustomColor(0) : () => ''}
        ...
        <g id='hair'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(1) : () => ''}
            stroke={fills.black}
        ...
        <g id='skin'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(2) : () => ''}
            stroke={fills.black}
        ...
        <g id='skin-shadows'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(3) : () => ''}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(4) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(5) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
          ...
          <motion.polyline
            ...
            onClick={clear === 'customize' ? () => onCustomColor(6) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
        ...
        <g id='eye-backs'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(7) : () => ''}
            stroke={fills.black}
        ...
        <g id='Pupils'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(8) : () => ''}
            stroke={fills.black}
        ...
        <g id='beard'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(9) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
        ...
        <g id='eyebrows'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(10) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
        ...
        <g id='sleeve-body'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(11) : () => ''}
            stroke={fills.black}
        ...
        <g id='sleeve-accent'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(12) : () => ''}
        ...
        <g id='shirt-body'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(13) : () => ''}
            stroke={fills.black}
        ...
        <g id='collar-thread'>
          <motion.path
            ...
            stroke={clear === 'customize' ? '#343434' : fills.shirt.band_accent}
        ...
        <g id='hat_bill' data-name='hat bill'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(14) : () => ''}
            stroke={fills.black}
        ...
        <g id='hat_top' data-name='hat top'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(15) : () => ''}
            stroke={fills.black}
        ...
        <g id='glasses'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(16) : () => ''}
            stroke={fills.black}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(17) : () => ''}
            stroke={fills.black}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(18) : () => ''}
            stroke={fills.black}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(19) : () => ''}
            stroke={fills.black}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(20) : () => ''}
            stroke={fills.black}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(21) : () => ''}
            stroke={fills.black}
        ...
        <g id='mouth'>
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(22) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(23) : () => ''}
            stroke={clear === 'customize' ? fills.black : ''}
          ...
          <motion.path
            ...
            onClick={clear === 'customize' ? () => onCustomColor(24) : () => ''}
            stroke={fills.black}
