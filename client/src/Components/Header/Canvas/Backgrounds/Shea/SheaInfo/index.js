    ...
    <>
      ...
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            In the summer of 2009, I put together a short Northeastern tour and
            had heard about a new venue in Greenpoint through some friends that
            knew the people behind it. It seemed like they were on to something
            special. The guy at the head of the operation, an audio engineer
            named Adam Reich was multitracking shows and releasing quality
            recordings of local bands' sets. Equally as exciting, it was named
            for the recently closed home of the Mets. So I checked in but they
            had closed and would soon relocate. With its fate in question, Adam
            agreed to host us for one of the earlier shows at the new space.
          </motion.p>
          <motion.p
            className='big-snow-desc'
            initial={{ opacity: 0 }}
      ...
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            ...
            helped each other bring our stuff up the stairs. Adam plugged in his
            iPod and pressed play. It was Raphael Sadiiq's The Way I See It. It
            all seemed too serendipitous but the show was a bust. Adam and
            everyone involved were welcoming and supportive nonetheless and we
            skipped town for the next show.
          </motion.p>
          <motion.p
            className='big-snow-desc'
            initial={{ opacity: 0 }}
          ...
          <motion.p
            ...
            exit={{ opacity: 0, transition: { duration: 1 } }}
          >
            Shea had changed since I was last there. It was more established and
            clearly finding its footing. Nora, a previous volunteer, had taken
            on a major role. The So So Glos were living in newly built bedrooms.
            It was a warm, familial atmosphere. For the next year, I
      ...
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            ...
            the folks at Shea took me in so I went back to working shows there.
            I even moved in for a bit and later started touring with The So So
            Glos as their tour manager.
          </motion.p>
          <motion.p
            className='big-snow-desc'
            initial={{ opacity: 0 }}
