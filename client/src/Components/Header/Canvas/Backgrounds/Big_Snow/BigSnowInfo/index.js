      ...
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            ...
            to generate revenue to pay the artists as much as possible.
          </motion.p>
          <motion.p
            className='big-snow-desc'
            initial={{ opacity: 0 }}
            ...
            exit={{ opacity: 0, transition: { duration: 1 } }}
          >
            The space was also our home with a full residence in the back of the
            building complete with three bedrooms and a closed off bathroom. We
            spent our days maintaining the space and working on programming or
            hosting a variety of productions from music video shoots to
            recording sessions or even TV shoots for networks like MTV.
          </motion.p>
        </div>
      </Grid>
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            ...
            high quality audio experience for all of our performers in a modest
            space and even recorded a few records in the building. We managed to
            fill our calendar with events almost every night, hosting bands and
      ...
      <Grid item xs={12} md={6}>
        <div className='text-content' style={{ justifyContent: 'center' }}>
          ...
          >
            ...
            suspicious activity on the street so I took a step outside to take a
            look for myself. I had one foot out the door when I heard a blast
            and realized I had been hit in the arm by a bullet. Of course we
            promptly shut down the show and I was taken to the hospital.
          </motion.p>
          <motion.p
            className='big-snow-desc'
            initial={{ opacity: 0 }}
            ...
            exit={{ opacity: 0, transition: { duration: 1 } }}
          >
            Unfortunately that would mark the end of our run. It was clear that
            we weren't a target but it felt wrong to bring people back to the
            space after such a public scare. I walked away with three wounds
            from a single gunshot, a shattered left forearm and quite a bit of
            nerve damage and embarked on what would be a successful recovery.
